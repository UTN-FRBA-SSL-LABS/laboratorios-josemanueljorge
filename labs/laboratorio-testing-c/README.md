...
> R:No, no pasa. Esperaba el valor 700 y recibio 350
...
> R:Si, carrito_descuento y return total. eso es debido a que no se ejecutaron porque nunca las utilizamos para hacer un test en general, si no mas bien las llamamos para comprobar con el ASSERT_IGUAL.
...
> R:El unitario hace foco en una sola funcion, mientras que el de integracion corrobora que todo funcione en conjunto. El que primero lo encontro fue el unitario, tal que, fue mas puntual y comprobo directamente.
...
> R: Porque C no te limita. A diferencia de python o java, C calcula la siguiente dirección de memoria y escribe en ella, lo que te permite acceder y sobrescribir variables o datos vitales que estaban guardados cerca.
...
> R: Que normalmente, uno no puede detectarlos de forma inmediata. Mas bien pasa horas tratando de detectarlo y muchas veces puede pasar que no lo encuentres. Con los tests, vos tenes un mejor diagnostico, con el cual se te puede facilitar encontrar el bug.
...
> R: Porque faltaba el multiplicar por la cantidad de items del producto.
